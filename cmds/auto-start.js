...
module.exports.run = async (bot, message, args) => {
    ...
    let voice = "534160331904122905";
    let codes = "534160776131248128";
    let general = "534160331904122903";
    ...
    let autoScrims = setInterval(() => {
        ...
        if (min === 55 || min === 25){
            ...
            embed.setTitle("NEXT MATCH START NOW, make sure your in the voice countdown channel");
